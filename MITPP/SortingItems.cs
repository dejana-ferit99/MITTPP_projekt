...
namespace SeleniumTests
{
    ...
    public class SortingItems
    {
        ...
        [Test]
        public void TheSortingItemsTest()
        {
            ...
            driver.FindElement(By.Id("js-site-search-input")).SendKeys("Miš");
            driver.FindElement(By.XPath("//span/button/span")).Click();
            driver.FindElement(By.Id("sortOptions1")).Click();
            new SelectElement(driver.FindElement(By.Id("sortOptions1"))).SelectByText("Cijeni (prvo najniža)");
        }
